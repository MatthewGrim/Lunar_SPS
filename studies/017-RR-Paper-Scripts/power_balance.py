...
def get_energy_balance():
    ...
    for i, rover_name in enumerate(rover_names):
        ...
        sps_active = determine_SPS_active_time_with_stored_power(target_eclipse, sps_access)
        if two_satellites[i]:
            ...
            sps_active_2 = determine_SPS_active_time_with_stored_power(target_eclipse, sps_access_2)
