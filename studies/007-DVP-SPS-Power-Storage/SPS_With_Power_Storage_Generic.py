...
def main():
    ...
    semi_maj_axis, eccentricity, orbit_data = vary_orbital_elements_incrementing_resolution(max_perigee, max_apogee, min_perigee=800.0, resolutions=resolutions, thresholds=thresholds)
    ...
    max_stored_power_time = sort_incremented_resolution_data(orbit_data, read_data_from_file(stk_data_path, study_name, 'MaxStoredPower_1SPS'), resolution=resolutions, thresholds=thresholds)
    total_stored_power_time = sort_incremented_resolution_data(orbit_data, read_data_from_file(stk_data_path, study_name, 'TotalStoredPower_1SPS'), resolution=resolutions, thresholds=thresholds)
