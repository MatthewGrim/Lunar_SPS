...
def main():
    ...
    plt.figure(1)
    plt.subplot(131)
    plt.plot(nearest_brandhorst_perigee, brandhorst_active_time)
    plt.xlabel('Angle of Perigee [deg]')
    plt.ylabel('Total Access Time [hrs]')
    plt.title('Actual Brandhorst Figure 3')
    plt.subplot(132)
    plt.plot(perigees, active_times_flip / 3600.0)
    plt.xlabel('Angle of Perigee [deg]')
    plt.ylabel('Total Access Time [hrs]')
    plt.title('Remake Brandhorst Figure 3')
    plt.subplot(133)
    plt.plot(nearest_brandhorst_perigee, percent_difference)
    plt.xlabel('Angle of Perigee [deg]')
    plt.ylabel('Error in Remake Data [%]')
    plt.title('Difference (Remake - Actual)')
    plt.show()
