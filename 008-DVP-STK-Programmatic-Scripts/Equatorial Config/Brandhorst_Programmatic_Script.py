...
def main():
    ...
    # Name of study
    study_name = 'Equatorial_{}kmRes_1min_Check'.format(resolution)
    ...
    sma, ecc, orbit_data = vary_orbital_elements(resolution, min_perigee, min_apogee, max_perigee, max_apogee)
