...
def main():
    ...
    # blacktivity = determine_blackout_data(active_times_circle_orbit, target_eclipse, total_duration)
    #
    # bs = [i / 86400.0 for i in blacktivity[0]]
    # bd = [i / 3600.0 for i in blacktivity[2]]
    # es = [i / 86400.0 for i in target_eclipse[0]]
    # ed = [i / 3600.0 for i in target_eclipse[2]]
    #
    # plt.subplot(211)
    # plt.bar(bs, bd)
    # plt.subplot(212)
